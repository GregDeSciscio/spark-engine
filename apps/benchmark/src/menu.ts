...
.menu .card { display: flex; flex-direction: column; gap: 8px; text-align: left; cursor: pointer;
  font: inherit; color: inherit; padding: 18px 20px; border: 1px solid #1c2233; border-radius: 8px;
  background: #0a0d15; transition: border-color 120ms, background 120ms, transform 120ms; }
