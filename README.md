...
URL parameters: `scene=bootstrap`, `backend=webgpu|webgl|auto`, `preset=low|medium|high|ultra|cinematic`, `scale=0.5..1`, `dpr=1`, `seed=1`, `overlay=0`, `fixedclock=60`, `paused=1`, `size=1280x720`, `log=debug`.
